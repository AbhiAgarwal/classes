...
%
%      MASS('Property','Value',...) creates a new MASS or raises
...
% Last Modified by GUIDE v2.5 21-Feb-2014 21:54:32
...
% --- Executes just before mass is made visible.
function mass_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to mass (see VARARGIN)

% Choose default command line output for mass
...
% UIWAIT makes mass wait for user response (see UIRESUME)
